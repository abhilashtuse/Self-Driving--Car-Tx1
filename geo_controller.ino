/*
 * CMPS11 and GPS code for Arduino
 * Based on CMPS11 I2C example for Arduino By James Henderson, 2014
 * Reads bearing angle from CMPS11 over I2C, latitude and longitude from GPS over UART
 */
#include <Wire.h>
